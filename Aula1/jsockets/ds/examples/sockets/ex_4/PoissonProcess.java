package ds.examples.sockets.ex_4;
...
public final class PoissonProcess {
    ...
    public double timeForNextEvent() {
        // The sequence of inter-arrival times are independent and have an exponential
        // distribution with mean 1/lambda.
        // To generate it we use the recipe in
    ...
    /**
     * Get number of occurrences in time t (assumed to be relative to the unit
     * time).
     * 
