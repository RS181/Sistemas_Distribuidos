...
/**
 * Represents a SINGLE peer that can act as a client or as a server, networks of these peers are
 * symmetric as all nodes feature the same functionality, the server performes arithmetic
 * operations as in the examples above.
 */
public class Peer {
	String host;
	Logger logger;
