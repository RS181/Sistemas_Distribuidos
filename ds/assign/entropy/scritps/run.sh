...
#gnome-terminal -- bash -c "java ds.assign.entropy.Peer localhost 20000 localhost 10000 localhost 30000 localhost 40000 ; " &
...
#gnome-terminal -- bash -c "java ds.assign.entropy.Peer localhost 40000 localhost 20000 localhost 50000 localhost 60000; " &

# Peer 5 (Initial neighbour = Peer 4)
#gnome-terminal -- bash -c "java ds.assign.entropy.Peer localhost 50000 localhost 40000" &

# Peer 6 (Initial neighbour = Peer 4)
#gnome-terminal -- bash -c "java ds.assign.entropy.Peer localhost 60000 localhost 40000" &
